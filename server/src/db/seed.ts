...
// Only run + close the pool when invoked directly as a CLI script (`npm run seed`).
// bootstrap.ts imports `runSeed` instead, and manages the pool's lifetime itself
// since the server keeps using it afterward.
